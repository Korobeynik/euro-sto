...
define('CRM_HOST', 'evrostokha.bitrix24.ua'); // your CRM domain name
define('CRM_PORT', '443'); // CRM server port
define('CRM_PATH', '/crm/configs/import/lead.php'); // CRM server REST service path

// CRM server authorization data
define('CRM_LOGIN', 'stokomplekt2@gmail.com'); // login of a CRM user able to manage leads
define('CRM_PASSWORD', 'a75438324351'); // password of a CRM user
